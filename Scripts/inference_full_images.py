...
for img_path in image_paths:
    ...
    # Εκτέλεση πρόβλεψης στην ολόκληρη εικόνα
    ...
    if SAVE_ANNOTATED_IMAGES:
        ...
        save_img_path = os.path.join(img_out_dir, f"{stem}.jpg")
